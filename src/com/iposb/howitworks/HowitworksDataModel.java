...
public class HowitworksDataModel {
	
	private int hid = 0;
	private String content_enUS = "";
	private String content_msMY = "";
	...
	public String getContent_msMY() {
		return content_msMY;
	}
	public void setContent_msMY(String content_msMY) {
		this.content_msMY = content_msMY;
	}
