...
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title><%=Resource.getString("ID_LABEL_PARTNERSHIPMENTREPORT",locale)%></title>
				...
				<div class="main-content">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li><%=Resource.getString("ID_LABEL_PARTNERSHIPMENT",locale)%></li>							
						</ul><!-- .breadcrumb -->
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
									...
									<form id="selector" name="selector" action="./partnerreport" method="get" class="form-horizontal">
										...
										<div class="form-group">
											<label class="col-sm-2 control-label no-padding-right" for="station"> <%=Resource.getString("ID_LABEL_STATION",locale)%> </label>
											<div class="col-sm-2">
												...
												<div class="col-xs-12">
													<div class="table-responsive">
														<table id="overall-table" class="table table-striped table-bordered table-hover">
															...
															<tbody>
																<%
																	if( (data != null && data.size() > 0) && (station > 0) ){
			...
			$(function() {
				$( "#generateReport" ).click(function() {
					...
					$(function() {
						$.ajax({
							url: './report',        
							data: "actionType=genPartnerReport&createDT="+createDT+"&station="+station+"&partnerId="+partnerId+"&stage="+stage,
							success: function(response) {

								if(response.indexOf(".pdf")!=-1) {
									$( "#loadingReport" ).html("<br/><br/><a href='https://s3-ap-southeast-1.amazonaws.com/iposb/partnerReport/"+response+"' target='_blank'><%=Resource.getString("ID_LABEL_GENERATEDPDF",locale)%> <img src='<%=resPath %>/assets/L10N/common/img/pdf.gif' border='0' /></a><br/><br/><br/>");
