...
<%	
	...
	if(actionType != null && actionType.equals("cpPricing_credit_document_update")){
		addEdit = true;
		list = false;
	} else {
		addEdit = false;
...
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title><%=Resource.getString("ID_LABEL_CREDITTERMUSER",locale)%> (<%=Resource.getString("ID_LABEL_AIRFREIGHTCOURIER",locale)%>) <%=Resource.getString("ID_LABEL_PRICINGMAINTAINANCE",locale)%></title>
				...
				<div class="main-content">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<% if(list){ 
									out.print("<li class=\"active\">"+Resource.getString("ID_LABEL_CREDITTERMUSER",locale)+ " (" + Resource.getString("ID_LABEL_AIRFREIGHTCOURIER",locale) + ") " +Resource.getString("ID_LABEL_PRICINGMAINTAINANCE",locale)+"</li>"); 
							   } else {
									out.print("<li><a href=\"./cpPricing_credit_document\">"+Resource.getString("ID_LABEL_CREDITTERMUSER",locale)+ " (" + Resource.getString("ID_LABEL_AIRFREIGHTCOURIER",locale) + ") " +Resource.getString("ID_LABEL_PRICINGMAINTAINANCE",locale)+"</a></li>"); 
												  ...
												  <tr>
													<td height="120">
														...
														<div class="form-group">
															...
															<div class="col-sm-9">
																<input type="text" id="title_enUS" name="title_enUS" placeholder="" class="col-xs-10 col-sm-5" value="<%=pricingData.getTitle_enUS() %>" maxlength="100" readonly disabled />
															</div>
														</div>
										...
										<div class="col-xs-12">
											...
											<div class="table-responsive">
												<table id="pricing-table" class="table table-striped table-bordered table-hover">
													<thead>
														<tr>
															<th class="center col-xs-2"><%=Resource.getString("ID_LABEL_NAMEEN",locale)%></th>
													...
													<tbody>
														...
														<tr>
															...
															<td align="center">
																<a href="pricing?actionType=cpPricing_credit_document_edit&pid=<%=pricingData.getPid() %>"><i class=" green icon-pencil bigger-130"></i></a>
															</td>
														</tr>
														<% }} %>
													</tbody>
...
<g:compress>
		<script type="text/javascript">
			...
			$(function() {
				...
				$( "#backPricingBtn" ).click(function() { location.href='./pricing?actionType=cpPricing_credit_document'; return false; });
			});
