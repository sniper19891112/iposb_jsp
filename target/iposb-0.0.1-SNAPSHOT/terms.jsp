<%@page import="com.iposb.i18n.*,com.iposb.term.*,com.iposb.utils.*,java.util.ArrayList,javax.servlet.http.HttpServletRequest"%>
...
<%
	...
	if(data != null && data.size() > 0){
		...
		content = termData.getContent_enUS();
		
		if(locale.equals("zh_CN")) {
			content = termData.getContent_zhCN();
		} else if(locale.equals("zh_TW")) {
			content = termData.getContent_zhTW();
		}
	}
...
<head>
    <title><%=Resource.getString("ID_LABEL_TERMSANDCONDITIONS",locale)%> - iPosb Logistic</title>
...
<body>
    ...
    <div class="banner padd">
		<div class="container">
			...
			<!-- Heading -->
			<h2 class="white"><%=Resource.getString("ID_LABEL_TERMSANDCONDITIONS",locale)%></h2>
			<ol class="breadcrumb">
				<li><a href="./"><%=Resource.getString("ID_LABEL_HOME",locale)%></a></li>
				<li class="active"><%=Resource.getString("ID_LABEL_TERMSANDCONDITIONS",locale)%></li>
			</ol>
