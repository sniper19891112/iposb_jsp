...
<%
	...
	if(!currentUser.isAuthenticated()){
		String url = "./login?returnUrl=./password";
    ...
    <div class="inner-page padd">
		...
		<div class="container">
			...
			<div class="row">
				...
				<jsp:include page="mySidebar.jsp?tab=password" />
				...
				<div class="col-md-9">
					...
					<form id="passwordForm" name="passwordForm" method="post" action="./logon" class="sky-form">
						<input type="hidden" id="actionType" name="actionType" value="updatePassword">
