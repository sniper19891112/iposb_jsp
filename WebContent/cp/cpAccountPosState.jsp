<%@page import="com.iposb.i18n.*,com.iposb.logon.*,com.iposb.account.*,java.util.ArrayList,java.text.*,java.util.Date,org.apache.commons.lang3.StringUtils" contentType="text/html; charset=utf-8"%>
...
<%	
	...
	String search_airwaybillNum = request.getParameter("search_airwaybillNum") == null ? "" : request.getParameter("search_airwaybillNum").toString();
%>
...
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title><%=Resource.getString("ID_LABEL_POSSTATEMENT",locale)%></title>
				...
				<div class="main-content">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li><%=Resource.getString("ID_LABEL_POSSTATEMENT",locale)%></li>							
						</ul><!-- .breadcrumb -->
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
									...
									<form id="selector" name="selector" action="./posStatement" method="get" class="form-horizontal">
									
										<div class="space-4"></div>
										
										<div class="form-group">
											<label class="col-sm-2 control-label no-padding-right" for="search_airwaybillNum"> <%=Resource.getString("ID_LABEL_AIRWAYBILLNUM",locale)%> </label>
											<div class="col-sm-3">
												<div class="input-group">
													<input class="form-control" id="search_airwaybillNum" name="search_airwaybillNum" type="text" value="<%=search_airwaybillNum %>">
												</div>
											</div>
										</div>
														...
														<table id="overall-table" class="table table-striped table-bordered table-hover">
															...
															<tbody>
																<%
																	...
																	double totalAmt = 0.0;
																	if( (data != null && data.size() > 0) && (search_airwaybillNum.length() > 0) ){
		...
		<script language="javascript" type="text/javascript">
			...
			$(function() {
				...
				$( "#checkBtn" ).click(function() { 
					...
					var airwaybillNum = $("#search_airwaybillNum").val();
					
					if(airwaybillNum == "") {
						alert ("Please enter an Air Waybill Number");
						return false;
					}
