...
<%	
	...
	if(actionType != null && actionType.equals("cpPricing_normal_document_update")){
		addEdit = true;
		list = false;
	} else {
		addEdit = false;
...
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title><%=Resource.getString("ID_LABEL_NORMALUSER",locale)%> (<%=Resource.getString("ID_LABEL_AIRFREIGHTCOURIER",locale)%>) <%=Resource.getString("ID_LABEL_PRICINGMAINTAINANCE",locale)%></title>
				...
				<div class="main-content">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<% if(list){ 
									out.print("<li class=\"active\">"+Resource.getString("ID_LABEL_NORMALUSER",locale)+ " (" + Resource.getString("ID_LABEL_AIRFREIGHTCOURIER",locale) + ") " +Resource.getString("ID_LABEL_PRICINGMAINTAINANCE",locale)+"</li>"); 
							   } else {
									out.print("<li><a href=\"./cpPricing_normal_document\">"+Resource.getString("ID_LABEL_NORMALUSER",locale)+ " (" + Resource.getString("ID_LABEL_AIRFREIGHTCOURIER",locale) + ") " +Resource.getString("ID_LABEL_PRICINGMAINTAINANCE",locale)+"</a></li>"); 
												...
												<table id="pricing-table" class="table table-striped table-bordered table-hover">
													...
													<tbody>
														...
														<tr>
															...
															<td align="center">
																<a href="pricing?actionType=cpPricing_normal_document_edit&pid=<%=pricingData.getPid() %>"><i class=" green icon-pencil bigger-130"></i></a>
															</td>
														</tr>
														<% }} %>
													</tbody>
...
<g:compress>
		<script type="text/javascript">
			...
			$(function() {
				...
				$( "#backPricingBtn" ).click(function() { location.href='./pricing?actionType=cpPricing_normal_document'; return false; });
			});
