		...
		<ul>	<!-- SLIDE  -->
			<li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
				...
				<div class="tp-caption lfl largeblackbg br-red" 
					...
					style="z-index: 3">We Deliver Anything...
				</div>
				<!-- LAYER NR. 2.0 -->
			...
			<li data-transition="zoomin" data-slotamount="6" data-masterspeed="400" >
				...
				<div class="tp-caption sfl modern_medium_light"
					...
					data-endspeed="500"
					data-endeasing="Power4.easeIn"
					style="z-index: 3">A Whole New World of
				</div>
				<!-- LAYER NR. 1.1 -->
				...
				<div class="tp-caption sft"
					...
					data-endspeed="500"
					data-endeasing="Power4.easeIn"
					style="z-index: 10"><span class="price-tag br-white">New<br />Era</span>
				</div>
				<!-- LAYER NR. 3 -->
				...
				<div class="tp-caption sfb"
					...
					data-endspeed="500"
					data-endeasing="Power4.easeIn"
					style="z-index: 11"><a class="btn btn-orange" href="#">Download</a> <a class="btn btn-success hidden-xs" href="#">Purchase Now</a>
				</div>
			</li>
			<li data-transition="slidehorizontal" data-slotamount="1" data-masterspeed="600" >
				<!-- MAIN IMAGE -->
				<img src="assets/img/slider/transparent.png" style="background-color:#fea501" alt=""  data-bgfit="cover" data-bgposition="center bottom" data-bgrepeat="no-repeat">
				<!-- LAYERS NR. 1 -->
				<div class="tp-caption lfl"
					...
					data-captionhidden="off"><img class="img-responsive" src="assets/img/slider/s35.png" alt="" />
				</div>
				<!-- LAYERS NR. 2 -->
				<div class="tp-caption lfr large_bold_grey heading white"
					...
					data-endspeed="300"
					data-endeasing="Linear.easeNone"
					data-captionhidden="off">Give us a try!
				</div>
				<!-- LAYER NR. 3 -->
				...
				<div class="tp-caption finewide_medium_white randomrotate customout tp-resizeme"
					...
					data-endelementdelay="0.08"
					data-endspeed="500"
					style="z-index: 4; max-width: auto; max-height: auto; white-space: nowrap;">Never Better
				</div>
				<!-- LAYER NR. 5 -->
			...
			<li data-transition="cube" data-slotamount="7" data-masterspeed="600" >
				...
				<div class="tp-caption lfl"
					...
					data-endspeed="300"
					data-endeasing="Power4.easeIn"
					data-captionhidden="off"><img src="assets/img/slider/s31.png" class="img-responsive" alt="" />
				</div>
				<!-- LAYERS NR. 2 -->
				<div class="tp-caption lfl"
					data-x="80"
					...
					data-endspeed="300"
					data-endeasing="Power4.easeIn"
					data-captionhidden="off"><img src="assets/img/slider/s33.png" class="img-responsive" alt="" />
				</div>
				<!-- LAYERS NR. 3 -->
				<div class="tp-caption lfl"
					data-x="450"
					...
					data-endspeed="300"
					data-endeasing="Power4.easeIn"
					data-captionhidden="off"><img src="assets/img/slider/s34.png" class="img-responsive" alt="" />
				</div>
				<!-- LAYERS NR. 4 -->
				...
				<div class="tp-caption lfr largepinkbg br-green"
					...
					data-endspeed="300"
					data-endeasing="Linear.easeNone"
					data-captionhidden="off">Volume Reserve
				</div>
				<!-- LAYERS NR. 5 -->
				...
				<div class="tp-caption lfr modern_big_redbg br-red"
					...
					data-endspeed="300"
					data-endeasing="Linear.easeNone"
					data-captionhidden="off">Online or Offline
				</div>	
				<!-- LAYERS NR. 6.1 // -->
				<div class="tp-caption lfr modern_big_redbg br-yellow"
					...
					data-endspeed="300"
					data-endeasing="Linear.easeNone"
					data-captionhidden="off">Credit Card or Cash
				</div>
			</li>
		</ul>
		<!-- Banner Timer -->
