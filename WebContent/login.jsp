...
<%
	...
	if(currentUser.isAuthenticated()){ //已經login
		String url = "./my";
...
<head>
    <title><%=Resource.getString("ID_LABEL_MEMBERLOGIN",locale)%></title>
...
<body>
	...
	<div class="banner padd">
		<div class="container">
			...
			<!-- Heading -->
			<h2 class="white"><%=Resource.getString("ID_LABEL_MEMBERLOGIN",locale)%></h2>
			<ol class="breadcrumb">
				<li><a href="./"><%=Resource.getString("ID_LABEL_HOME",locale)%></a></li>
				<li class="active"><%=Resource.getString("ID_LABEL_MEMBERLOGIN",locale)%></li>
			</ol>
    	...
    	<div class="row">
            <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">	
				...
				<div class="booking-form" style="margin-top:48px;margin-bottom:28px">
					...
					<p><%=Resource.getString("ID_LABEL_NOACCOUNT",locale)%></p>	
				</div>
