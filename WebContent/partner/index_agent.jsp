...
<%
	if(priv != 3){ //neither agent nor parther
		...
		<script type="text/javascript">
			...
			$("#searchBtn").click(function() { 
				...
				if(trim(consignmentNo)=="") {
					...
					$("#actionType").val("searchAgentConsignment");
